              ...
              <div class="col-md-6">
                <form action="" method="" class="border border-2 p-3">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control" name="eventName" id="name"
                      placeholder="Enter event name..." />
                  </div>

                  <div class="form-group">
                    <label for="description">Description</label>
                    <textarea class="form-control" name="eventDescription" id="comment" rows="5">
                      </textarea>
                  </div>

                  <div class="form-group">
                    <label for="largeInput">Event Date</label>
                    <input type="date" class="form-control form-control" name="eventDate"
                      id="name" />
                  </div>

                  <div class="form-group">
                    <label for="largeInput">Event Time</label>
                    <input type="time" class="form-control form-control" name="eventTime"
                      id="name" />
                  </div>

                  <div class="form-group">
                    <label for="largeInput">Event Location</label>
                    <input type="text" class="form-control form-control" name="eventLocation"
                      id="name" placeholder="Enter event location..." />
                  </div>

                  <div class="form-group">
                    <label for="largeInput">Registration Due Date</label>
                    <input type="date" class="form-control form-control" name="dueDate" id="name" />
                  </div>

                  <div class="form-group">
                    <label for="largeInput">Participant Limit</label>
                    <input type="text" class="form-control form-control" name="participantLimit"
                      id="name" placeholder="10" />
                  </div>

                  <div class="form-group">
                    <label for="defaultSelect">Age Group</label>
                    <select class="form-select form-control" id="defaultSelect" name="ageGroup">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control-file" name="eventPhoto"
                      id="exampleFormControlFile1" />
                  </div>

                  <div class="form-group mb-3">
                    <label for="defaultSelect">Sport Type</label>
                    <select class="form-select form-control" id="defaultSelect" name="sportType">
