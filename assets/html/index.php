...
<body>
    ...
    <section id="filter-events" class="filter-section bg-dark py-5 text-light">
        <div class="container">
            ...
            <!-- Filter Form -->
            <form action="index.php" method="POST" class="filter-form p-4 rounded shadow-lg bg-black" data-aos="fade-up"
                data-aos-delay="300">
                <div class="row g-4">
                    <!-- Date Filter -->
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="filter-sport" name="filter_sport"
                            class="form-select bg-dark text-light border-primary shadow" required>
                ...
                echo '<option value="' . $sport['id'] . '">' . $sport['name'] . '</option>';
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="filter_location" id="location-selection"
                            class="form-select bg-dark text-light border-primary shadow" required>
                ...
                echo '<option value="' . $location['location'] . '">' . ucwords($location['location']) . '</option>';
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="filter" name="filter_agegroup"
                            class="form-select bg-dark text-light border-primary shadow" required>
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1500">
                        <div class="event-card p-4 text-light rounded shadow-lg">
                            <div class="event-header">
                                <img src="../../<?php echo $showevent['image'] ?>"
                                    alt="<?php echo $showevent['name'] ?>" class="img-fluid rounded mb-3" />
                            </div>
                            <div class="event-info">
                                ...
                                <a href="eventdetails.php?event_id=<?php echo $showevent['id'] ?>"
                                    class="btn custom-btn-lg">Learn More</a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
